...
Usage:
    python -m experiments.phase6_neural_warm_baseline
    python -m experiments.phase6_neural_warm_baseline --steps 1000 --seed 42 --seeds 5
"""
...
from src.experiments.phase2_trait_volatility import CONDITIONS, Condition
...
EXPERIMENTS = {
    "phase6_warm_A": Experiment(
        name="Neural Warm Start — Baseline",
        description="Warm-started neural genome on standard environment. Functional navigation preserved.",
        result_id="phase6_warm_A",
        env_config={"drift_step": 1, "noise_rate": 3.0, "noise_magnitude": 2.0},
        **_BASE,
    ),
    "phase6_warm_B": Experiment(
        name="Neural Warm Start — Fast Drift",
        description="Warm start under fast drift. Population stable — selection maintains function.",
        result_id="phase6_warm_B",
        env_config={"drift_step": 3, "noise_rate": 3.0, "noise_magnitude": 2.0},
        **_BASE,
    ),
    "phase6_warm_C": Experiment(
        name="Neural Warm Start — Boom/Bust",
        description="Warm start under boom/bust. Probe spreads maintained across all conditions.",
        result_id="phase6_warm_C",
        env_config={"drift_step": 1, "noise_rate": 8.0, "noise_magnitude": 4.0},
        **_BASE,
    ),
    "phase6_warm_D": Experiment(
        name="Neural Warm Start — Combined Volatility",
        description="Warm start under maximum volatility. Asexual baseline before sexual reproduction.",
        result_id="phase6_warm_D",
