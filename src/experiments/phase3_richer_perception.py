...
from src.experiments.phase2_trait_volatility import (
    CONDITIONS,
    Condition,
...
EXPERIMENTS = {
    "phase3_richer_A": Experiment(
        name="Richer Perception — Baseline",
        description="Adds gradient, density, relative energy inputs. Energy awareness rises sharply.",
        result_id="phase3_richer_A",
        env_config={"drift_step": 1, "noise_rate": 3.0, "noise_magnitude": 2.0},
        **_BASE,
    ),
    "phase3_richer_B": Experiment(
        name="Richer Perception — Fast Drift",
        description="Richer perception under fast drift. More viable strategies emerge.",
        result_id="phase3_richer_B",
        env_config={"drift_step": 3, "noise_rate": 3.0, "noise_magnitude": 2.0},
        **_BASE,
    ),
    "phase3_richer_C": Experiment(
        name="Richer Perception — Boom/Bust",
        description="Richer perception under boom/bust. Energy awareness highest of all conditions.",
        result_id="phase3_richer_C",
        env_config={"drift_step": 1, "noise_rate": 8.0, "noise_magnitude": 4.0},
        **_BASE,
    ),
    "phase3_richer_D": Experiment(
        name="Richer Perception — Combined Volatility",
        description="Most volatile condition with richer inputs. Maximum behavioral diversification.",
        result_id="phase3_richer_D",
